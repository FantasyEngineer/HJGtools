 ...
 * 横向等待框
 */
public class SpecialHorizontalLoadingDialog extends BaseAlertDialog<SpecialHorizontalLoadingDialog> {
    ...
    public SpecialHorizontalLoadingDialog(Context context) {
        super(context);
    }
     ...
     */
    public SpecialHorizontalLoadingDialog(Context context, long periodMilliseconds) {
        super(context);
     ...
     */
    public SpecialHorizontalLoadingDialog(Context context, long periodMilliseconds, @DrawableRes int progressDrawable) {
        super(context);
        this.periodMilliseconds = periodMilliseconds;
    ...
    public void setUiBeforShow() {
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                i = i + 5;
                i2 = i2 + 5;
                if (i >= maxProgress && i2 >= maxProgress) {
                    i = 0;
                }
                if (i2 >= maxProgress) {
                    i2 = -30;
     ...
     * @return
     */
    public SpecialHorizontalLoadingDialog setTip(String tip) {
        this.tip = tip;
        return this;
    }
     ...
     * @return
     */
    public SpecialHorizontalLoadingDialog setTextSize(int textSize) {
     ...
     * @return
     */
    public SpecialHorizontalLoadingDialog setTextColor(String textColor) {
