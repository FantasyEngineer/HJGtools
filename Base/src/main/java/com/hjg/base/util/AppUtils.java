...
public class AppUtils {
    ...
    public static boolean installAppSilent(String filePath) {
        ...
        ShellUtils.CommandResult commandResult = ShellUtils.execCmd(command, !isSystemApp(HJGUtils.getContext()), true);
    ...
    public static Signature[] getAppSignature(Context context, String packageName) {
        if (StrUtil.isEmpty(packageName)) return null;
        try {
            PackageManager pm = context.getPackageManager();
    ...
    public static boolean isAppForeground(Context context, String packageName) {
        return !StrUtil.isEmpty(packageName) && packageName.equals(ProcessUtils.getForegroundProcessName());
    }
