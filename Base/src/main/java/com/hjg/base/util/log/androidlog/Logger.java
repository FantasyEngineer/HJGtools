package com.hjg.base.util.log.androidlog;
...
import static com.hjg.base.util.log.LogLevel.TYPE_DEBUG;
import static com.hjg.base.util.log.LogLevel.TYPE_ERROR;
import static com.hjg.base.util.log.LogLevel.TYPE_INFO;
import static com.hjg.base.util.log.LogLevel.TYPE_VERBOSE;
import static com.hjg.base.util.log.LogLevel.TYPE_WARM;
import static com.hjg.base.util.log.LogLevel.TYPE_WTF;
import static com.hjg.base.util.log.utils.Utils.DIVIDER_BOTTOM;
import static com.hjg.base.util.log.utils.Utils.DIVIDER_CENTER;
import static com.hjg.base.util.log.utils.Utils.DIVIDER_NORMAL;
import static com.hjg.base.util.log.utils.Utils.DIVIDER_TOP;
import static com.hjg.base.util.log.utils.Utils.printDividingLine;
...
class Logger implements Printer {
    ...
    private StackTraceElement getCurrentStackTrace() {
        ...
        int stackOffset = getStackOffset(trace, L.class);
        if (stackOffset == -1) {
