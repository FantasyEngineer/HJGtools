...
public class FragmentUtils {
    ...
    public static void removeFragment(@NonNull Fragment fragment) {
        operateFragment(fragment.getParentFragmentManager(), null, fragment, TYPE_REMOVE_FRAGMENT);
    }
    ...
    public static void removeToFragment(@NonNull Fragment fragment, boolean isIncludeSelf) {
        operateFragment(fragment.getParentFragmentManager(), isIncludeSelf ? fragment : null, fragment, TYPE_REMOVE_TO_FRAGMENT);
    }
    ...
    public static Fragment replaceFragment(@NonNull Fragment srcFragment,
        ...
        return replaceFragment(srcFragment.getParentFragmentManager(), destFragment, containerId, isAddStack);
    }
    ...
    public static Fragment hideFragment(@NonNull Fragment fragment) {
        ...
        return operateFragment(fragment.getParentFragmentManager(), null, fragment, TYPE_HIDE_FRAGMENT);
    }
    ...
    public static Fragment showFragment(@NonNull Fragment fragment) {
        ...
        return operateFragment(fragment.getParentFragmentManager(), null, fragment, TYPE_SHOW_FRAGMENT);
    }
    ...
    public static Fragment hideShowFragment(@NonNull Fragment hideFragment,
        ...
        return operateFragment(showFragment.getParentFragmentManager(), hideFragment, showFragment, TYPE_HIDE_SHOW_FRAGMENT);
    }
    ...
    public static Fragment getPreFragment(@NonNull Fragment destFragment) {
        FragmentManager fragmentManager = destFragment.getParentFragmentManager();
    ...
    public static boolean dispatchBackPress(@NonNull Fragment fragment) {
        return dispatchBackPress(fragment.getParentFragmentManager());
    }
