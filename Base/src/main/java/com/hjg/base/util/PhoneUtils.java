...
public class PhoneUtils {
    ...
    public static boolean isPhone() {
        TelephonyManager tm = (TelephonyManager) HJGUtils.getContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getPhoneStatus() {
        TelephonyManager tm = (TelephonyManager) HJGUtils.getContext()
    ...
    public static void sendSms(String phoneNumber, String content) {
        Uri uri = Uri.parse("smsto:" + (StrUtil.isEmpty(phoneNumber) ? "" : phoneNumber));
        Intent intent = new Intent(Intent.ACTION_SENDTO, uri);
        intent.putExtra("sms_body", StrUtil.isEmpty(content) ? "" : content);
        HJGUtils.getContext().startActivity(intent);
    }
    ...
    public static void sendSmsSilent(String phoneNumber, String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(HJGUtils.getContext(), 0, new Intent(), 0);
    ...
    public static List<HashMap<String, String>> getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = HJGUtils.getContext().getContentResolver();
        ...
        while (cursor.moveToNext()) {
            ...
            // 判断contact_id是否为空
            if (!StrUtil.isEmpty(contact_id)) {//null   ""
