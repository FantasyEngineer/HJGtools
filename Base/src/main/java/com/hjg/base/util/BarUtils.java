...
public class BarUtils {
    ...
    public static void setTitleCenter(Toolbar toolbar, String title) {
        ...
        LayoutInflater inflater = LayoutInflater.from(HJGBaseApplication.app);

        View view = inflater.inflate(R.layout.titlebar, null);
//        TextView titleText = new TextView(HJGBaseApplication.app);
//        titleText.setTextColor(ResUtils.getColor(R.color.wheat));
