...
import com.hjg.base.util.log.LogConfig;
import com.hjg.base.util.log.LogLevel;
import com.hjg.base.util.log.Parser;
import com.hjg.base.util.log.parser.ParserManager;

import static com.hjg.base.util.log.pattern.LogPattern.compile;
...
class LogConfigImpl implements LogConfig {
    ...
    String getFormatTag(StackTraceElement caller) {
        ...
        return compile(formatTag).apply(caller);
    }
