...
public class ConstUtils {
    ...
    public static final String SHAREPREFERENCENAME = "HJGBASE";
     ...
     * 大写英文
     */
    public static final String REGEX_EN_UPPER = "^[A-Z]+$";
    /**
     * 小写英文
     */
    public static final String REGEX_EN_LOWER = "^[a-z]+$";
    /**
     * 英文和数字
     */
     ...
     * 零和非零开头的数字
     */
    public static final String REGEX_FIRST_NUM_0_OR_NOT0 = "^(0|[1-9][0-9]*)$";
    /**
